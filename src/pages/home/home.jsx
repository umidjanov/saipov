				...
				>
					{[
						...
						},
						{
							...
							description:
								"Элегантный комфорт на каждый день.",
				...
				<div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
					<div className="flex-1">
						...
						<p className="text-gray-700 text-sm leading-relaxed mb-3">
							Компания основана 2012 году. Основатель
							Саипов Музаффар. За эти годы компания
							успешно сотрудничает с крупными брендами:
							Yoyo store, Yaskammu, Modern Fashion,
							Parisa home.
						</p>
						<p className="text-gray-700 text-sm leading-relaxed mb-3">
							Благодаря качеству и надёжности, Saipov
							Group — надёжный партнёр не только по
							продуктам, но и по ценностям.
						</p>
						<p className="text-gray-700 text-sm leading-relaxed">
							Наша команда работает над улучшением,
							внедрением новых технологий и расширением
							ассортимента.
						</p>
					</div>
